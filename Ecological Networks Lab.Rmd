...
-   Mostly PhD students, one post-doc, and Lucas. Most are not familiar with networks.

-   Introduction -- perhaps take 10 minutes to show a network, make a comparison of a network and the matrix. Make a powerpoint for this, look a iGraph in R (plot network, show matrix). With any of the concepts, use a part of a small network (visualize in that network). Use that image/concept to explain what the variables are.

-   15 minutes of introductions/overview. 15 minutes of powerpoint. 45 minutes of part 1 (introductory material).
...
-   Sergio book chapter. Use ecological networks for ecosystem management. Isidora also a collaborator.
...
#### Exercise 2.1 Simulating network extinctions (main focus of the session)
...
#### Exercise 2.2 Introducing extinction thresholds (optional)
...
#### Exercise 2.3 Introducing rewiring potential (optional)
...
#### Reflection 4.1 - Connecting oceanography and ecology
...
#### Reflection 4.2 - Static vs dynamic networks
