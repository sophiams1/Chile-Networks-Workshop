...
#as an example, we have removed all species that are scavengers from the network
scavenger_ids = species_char$Matrix.code[species_char$TL=="Scavenger"]
new_chilean_intertidal <- delete.vertices(chilean_intertidal,)
  
Mostconnected <- SimulateExtinctions(Network = new_chilean_intertidal, Method = "Mostconnected",
NetworkType = "Trophic", # default argument
IS = 0, # default argument
Rewiring = FALSE # default argument
)
...
#create a new data frame adding species characteristics to the extinction output
#extract_char <- species_char[Output$Spp,]
#new_chilean_intertidal <- merge(Output,extract_char)
